...
INSERT INTO reviews (user_name, place_name, content, rating,createdAt, updatedAt, placeId) VALUES ('Kelly Hernandez','Queen City Grounds', 'The people who work here are so kind. Wifi is super fast and there's lots of room to sit and study with friends' 4, NOW(), NOW(),9);